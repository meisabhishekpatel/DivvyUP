...
export default function Login() {
    ...
    return (
        <animated.div style={slideIn} className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 bg-gray-50">
            <animated.div style={fadeIn} className="w-full px-6 py-4 mt-6 overflow-hidden bg-gray-50 sm:max-w-lg sm:rounded-lg">
                <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
                    <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
                        ...
                        <form className="mt-6">
                            <div className="mb-2">
                                ...
                                <input
                                    ...
                                    className={`block w-full px-4 py-2 mt-2 text-blue-700 bg-white border rounded-md focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 ${!isEmailValid ? "border-red-500" : ""
                                        }`}
                                />
                                {!isEmailValid && (
                        ...
                        <div className="flex mt-4 gap-x-2">
                            <button
                                className="px-4 py-2 border flex w-full gap-2 items-center justify-center border-slate-700 rounded-lg text-black-200 hover:border-slate-500 hover:text-slate-300 hover:shadow transition duration-150"
                            >
                                <img
                                    className="w-6 h-6"
